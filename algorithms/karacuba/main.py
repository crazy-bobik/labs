...
x, y = norm(x, y)  #рівняємо числа перед початком і виводимо для контролю
print(x, y)
m = karacuba(x, y)  #викликаємо функцію множення і виводимо результат
print("Добуток = " + str(m))
n = int(x) * int(y)  #множимо задані числа як цілі стандартними методами питона і виводимо (для перевірки коректності результату)
print("Перевірка=" + str(n))
print(i)  #виводимо кінцеве значення лічильника
