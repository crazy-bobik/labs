...
double k1( double x, double y, double h, double(*f)(double, double) )
{
	return(h*f(x, y));
}
...
double k2( double x, double y, double h, double(*f)(double, double), double q1 )
{
...
double k3( double x, double y, double h, double(*f)(double, double), double q2 )
{
...
double k4( double x, double y, double h, double(*f)(double, double), double q3 )
{
	return(h*f((x + h), y + q3));
}
...
double Yn( double y, double q1, double q2, double q3, double q4 )
{
